...
void CTransformBar::Init(void)
{
	...
	m_bTrans[MAX_PLAYER] = false;	// 変身しているかどうか
...
void CTransformBar::Update(void)
{
	...
	else
	{
		...
		if (m_nPlayerNum == 0)
		{
			...
			// BarHP
			m_pBar->SetVertexBarW(11, D3DXVECTOR3(153, 620, 0), D3DXCOLOR(0.0f, 1.0f, 1.0f, 0.0f), fHeight, BAR_HEGTH);
		}
	}
	...
	{
	 // Barフレーム
		m_pBar->SetVertexBarWL(12, D3DXVECTOR3(1130, 620, 0), NORMAL_COLOR, BAR_WIDTH * 2, BAR_HEGTH + 15);

		// BarHP
		m_pBar->SetVertexBarWL(13, D3DXVECTOR3(1027, 620, 0), D3DXCOLOR(0.0f, 1.0f, 1.0f, 1.0f), fHeight, BAR_HEGTH);
	}
	else
	{
		// Barフレーム
		m_pBar->SetVertexBarWL(12, D3DXVECTOR3(1130, 620, 0), ZeroColor, BAR_WIDTH * 2, BAR_HEGTH + 15);

		// BarHP
		m_pBar->SetVertexBarWL(13, D3DXVECTOR3(1027, 620, 0), D3DXCOLOR(0.0f, 1.0f, 1.0f, 0.0f), fHeight, BAR_HEGTH);
	}
}
...
// オブジェクトの生成
//==================================================================================================================
CTransformBar * CTransformBar::Create(int nNumber, float fMaxHP)
{
